...
import { installIOSTouchGuards } from "/flip-flap-notes/ios-touch-guards.js";
...
const DEFAULT_CONFIG = {
  ...
  backgroundPreset: "/flip-flap-notes/data/cyber-network.webp", // 初期値はCyber Network。""=なし / プリセットURL / "custom"（本体は IndexedDB に保存）
...
function saveConfig(c) {
  localStorage.setItem("FlipFlapNotesConfig", JSON.stringify(c));
}
...
function initWorker() {
  ...
  worker = new Worker("/flip-flap-notes/rhythm-game-worker.js", {
    type: "module",
  });
...
function changeLang() {
  ...
  location.href = `/flip-flap-notes/${lang}/`;
}
...
function initBeatWorker() {
  ...
  beatWorker = new Worker("/flip-flap-notes/beatmap-worker.js", {
    type: "module",
  });
...
const BG_DB_NAME = "FlipFlapNotesBackground";
